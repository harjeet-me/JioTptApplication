...
/**
 * REST controller for managing {@link com.jio.tms.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public List<Customer> getAllCustomers(@RequestParam(required = false) String filter) {
        if ("accounts-is-null".equals(filter)) {
            log.debug("REST request to get all Customers where accounts is null");
            return customerService.findAllWhereAccountsIsNull();
        }
